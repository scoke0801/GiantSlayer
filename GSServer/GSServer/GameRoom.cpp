...
void CGameRoom::EnterPlayer(CLIENT* client, int id)
{
}
...
void CGameRoom::ReadObstaclesPosition()
{
...
XMFLOAT3 CGameRoom::GetPosition(const string& name, const Document& document)
{
	XMFLOAT3 pos;
