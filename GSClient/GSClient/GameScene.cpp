...
void CGameScene::CreateRootSignature(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
...
void CGameScene2::Init(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	m_pd3dGraphicsRootSignature = CreateGraphicsRootSignature(pd3dDevice);
...
{ 
	...
	m_ppObjects[1]->SetPosition({ 0,  00,  00 });
	...
	m_ppObjects[3]->SetPosition({ 0,  00,  00 });
...
void CGameScene2::BuildDescripotrHeaps(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	//
	// Create the SRV heap.
	//
...
void CGameScene2::Update(double elapsedTime)
{
	ProcessInput();
}
...
void CGameScene2::Draw(ID3D12GraphicsCommandList* pd3dCommandList)
{
	pd3dCommandList->SetGraphicsRootSignature(m_pd3dGraphicsRootSignature);
...
void CGameScene2::OnMouseDown(WPARAM btnState, int x, int y)
{
	m_LastMousePos.x = x;
	m_LastMousePos.y = y;
...
void CGameScene2::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void CGameScene2::OnMouseMove(WPARAM btnState, int x, int y)
{
