...
void CFramework::Draw()
{
	...
	//	//m_CurrentScene->DrawPlayer_Shadow(m_pd3dCommandList); 
	...
	m_CurrentScene->DrawMirror(m_pd3dCommandList, m_ppd3dSwapChainBackBuffers[m_nSwapChainBufferIndex],0);
	...
	m_CurrentScene->DrawMirror(m_pd3dCommandList, m_ppd3dSwapChainBackBuffers[m_nSwapChainBufferIndex], 1);
	...
	m_CurrentScene->DrawMirror(m_pd3dCommandList, m_ppd3dSwapChainBackBuffers[m_nSwapChainBufferIndex], 2);
	...
	m_pd3dCommandList->ClearDepthStencilView(d3dDsvCPUDescriptorHandle, D3D12_CLEAR_FLAG_DEPTH | D3D12_CLEAR_FLAG_STENCIL, 1.0f, 0, 0, NULL);
	m_CurrentScene->DrawFont(m_pd3dCommandList);
