...
Texture2D gtxtEffect_4		: register(t52);

Texture2D gtxtFireBall		: register(t53);

Texture2D gtxtMap			: register(t54);
Texture2D gtxtMirror		: register(t55);
Texture2D gtxtShadowMap		: register(t56);
