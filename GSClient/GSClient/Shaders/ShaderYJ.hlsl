...
Texture2D gtxtGreenTree : register(t48);
Texture2D gtxtBow : register(t49);

Texture2D gtxtMap : register(t50);
Texture2D gtxtMirror : register(t51);
Texture2D gtxtShadowMap : register(t52);
