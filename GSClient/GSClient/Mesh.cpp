...
CFireBallParticleMesh::CFireBallParticleMesh(ID3D12Device* pd3dDevice,
	ID3D12GraphicsCommandList* pd3dCommandList,
	int particleCount) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = particleCount * 6;
...
CFireBallParticleMesh::~CFireBallParticleMesh()
{
}

void CFireBallParticleMesh::CreateMeshes(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, int count)
{
	const float PARTICLE_SIZE = 0.2f;
...
void CFireBallParticleMesh::CreateVertexBuffer(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	m_pd3dVertexBuffer = ::CreateBufferResource(pd3dDevice, pd3dCommandList, m_Vertices,
		m_nStride * m_nVertices, D3D12_HEAP_TYPE_DEFAULT,
		D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER, &m_pd3dVertexUploadBuffer);
