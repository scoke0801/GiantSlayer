...
#pragma region for Debuging Keys	
	...
	if (GetAsyncKeyState(VK_F6) & 0x8000)		m_Inputs.KEY_F6 = true;
	if (GetAsyncKeyState(VK_F7) & 0x8000)		m_Inputs.KEY_F7 = true;
	if (GetAsyncKeyState(VK_F8) & 0x8000)		m_Inputs.KEY_F8 = true;
	...
	if (GetAsyncKeyState(VK_C) & 0x8001)		m_Inputs.KEY_C = true;
	//if(GetAsyncKeyState(VK_C)&0x)

	if (GetAsyncKeyState(VK_R) & 0x8000)		m_Inputs.KEY_R = true;
	if (GetAsyncKeyState(VK_Z) & 0x8000)		m_Inputs.KEY_Z = true;
